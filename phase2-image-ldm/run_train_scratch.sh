...
VAE_CKPT="./phase2-image-vae/outputs_vae_image_128_v2_scratch/checkpoints/autoencoderkl_best_weights.pt"

python phase2-image-ldm/train_ldm_3d_image.py \
    --cache_dir "$CACHE_DIR" \
    --vae_checkpoint "$VAE_CKPT" \
    --output_dir ./phase2-image-ldm/outputs_ldm_image_v2_scratch \
    --batch_size 1 \
    --num_epochs 300 \
    --val_interval 20 \
    --save_interval 50 \
